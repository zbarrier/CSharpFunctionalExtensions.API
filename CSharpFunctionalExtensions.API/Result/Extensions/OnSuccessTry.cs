...
namespace CSharpFunctionalExtensions.API {
    public static partial class ResultExtensions {
        ...
        public static Result<T> OnSuccessTry<T>(this Result result, Func<T> func, Func<Exception, Error> errorHandler = null) {
            return result.IsFailure
        ...
        public static Result<K> OnSuccessTry<T, K>(this Result<T> result, Func<T, K> func, Func<Exception, Error> errorHandler = null) {
            return result.IsFailure
