...
namespace CSharpFunctionalExtensions.API {
    public static partial class AsyncResultExtensionsLeftOperand {
        ...
        /// </summary>
        public static async Task<K> Match<K, T>(this Task<Result<T>> resultTask, Func<T, K> onSuccess, Func<Error, K> onFailure) {
        ...
        /// </summary>
        public static async Task Match<T>(this Task<Result<T>> resultTask, Action<T> onSuccess, Action<Error> onFailure) {
        ...
        ///     Invokes the given <paramref name="onSuccess"/> action if the calling Result is a success. Otherwise, it invokes the given <paramref name="onFailure"/> action.
        /// </summary>
        public static async Task Match(this Task<Result> resultTask, Action onSuccess, Action<Error> onFailure) {
            (await resultTask.DefaultAwait()).Match(onSuccess, onFailure);
        }
    }
}
